...
FOCAL_LENGTH: float = 3.6 #1.8 # mm # 3.6, the specs say 3.6 but it's definitely half that
FULL_PIXEL_SIZE: float = 0.003 # mm
PIXEL_SIZE: float = FULL_PIXEL_SIZE * (FULL_STERO_HORIZONTAL_RESOLUTION / STERO_HORIZONTAL_RESOLUTION)
PIXEL_SIZE_DEBUG: float = FULL_PIXEL_SIZE * (FULL_STERO_HORIZONTAL_RESOLUTION / DEBUG_STERO_HORIZONTAL_RESOLUTION)
